...
namespace CCFlow.WF.UC
{
    public partial class FHLFlow : BP.Web.UC.UCBase3
    {
        ...
        {
            this.Page.Title = "工作处理";
            
            // 退回流程.
            this.ToolBar1.Add("<input class=Btn type=button onclick=\"javascript:window.location.href='./WorkOpt/ReturnWork.aspx?FromUrl=FHLFlow&WorkID=" + this.WorkID + "&FK_Flow=" + this.FK_Flow + "&FK_Node=" + this.FK_Node + "&FID=" + this.FID + "'\" value='退回' >");
