...
namespace CCFlow.WF.UC
{
    public partial class BatchStart : BP.Web.UC.UCBase3
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.AddFieldSet("流程属性设置错误");
                this.Add("您需要在流程属性里设置批量发起需要填写的字段。");
                this.AddFieldSetEnd();
            }
...
#warning 此处需要优化
            ...
            #region 文件上传.
            this.AddFieldSet("通过Excel导入方式发起:<a href='/DataUser/BatchStartFlowTemplete/" + this.FK_Flow + ".xls'><img src='/WF/Img/FileType/xls.gif' />下载Excel模版</a>");
            this.Add("文件名:");
