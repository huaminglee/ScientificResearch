...
<script type="text/javascript">
    ...
    function TBHelp(ctrl, enName, attrKey) {
        ...
        var url = "../Comm/HelperOfTBEUI.aspx?EnsName=" + enName + "&AttrKey=" + attrKey + "&WordsSort=2" + "&FK_Flow=<%=FK_Flow %>" + "&id=" + ctrl;
        var str = "";
...
<table border="0" style="width: 100%; height: 100%" align="center">
    <caption>
        您好:<%=BP.WF.Glo.GenerUserImgSmallerHtml(BP.Web.WebUser.No,BP.Web.WebUser.Name) %></caption>
    <tr>
        <td valign="top">
              <table border="0" style="width: 100%; height: 100%" align="center">
                <tr>
