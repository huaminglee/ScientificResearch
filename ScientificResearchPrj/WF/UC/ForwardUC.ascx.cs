...
namespace CCFlow.WF.UC
{
    public partial class Forward_UC : BP.Web.UC.UCBase3
    {
        ...
        public void BindLB()
        {
            ...
            //新增
            Label lb = new Label();
            lb.Text = "<div style='float:left;display:block;width:100%'><a href=javascript:TBHelp('TB_Doc')><img src='" + BP.WF.Glo.CCFlowAppPath + "WF/Img/Emps.gif' align='middle' border=0 />选择词汇</a>&nbsp;&nbsp;</div>";
            this.Top.Add(lb);
