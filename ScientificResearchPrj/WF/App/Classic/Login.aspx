<%@ Page Language="C#" AutoEventWireup="true" Inherits="AppDemo_Login1" CodeBehind="Login.aspx.cs" %>
		...
		<div class="main-inner" 
            ...
            <tr >
             <td colspan="2" class="style8">
              &nbsp;&nbsp;<img src="Img/yaoshi.jpg"  style=" width:29px; height:12px;" />
                ...
                <td class="style1">
                 &nbsp;&nbsp;<cc1:lab ID="Lab1" runat="server">
                  ...
                  <cc1:TB ID="TB_No"  runat="server" ShowType="TB"  Font-Bold="true"
                                Width="164px" Height="28px" BorderStyle="None" Font-Size="14px"></cc1:TB>
                </td>
               </tr>
               <tr>
                <td >
    ...
    <footer id="footer" class="footer">
		<div class="footer-inner" id="footerInner">			
			<nav class="footerNav">
                ...
                |济南驰骋信息技术有限公司公司版权所有 &copy; 2003-2014</span>&nbsp;&nbsp;咨询电话:0531-82374939
			</nav>
		</div>
	</footer>
    </form>
