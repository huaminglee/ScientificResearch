        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (wls.Count > 0)
            {
                ...
                foreach (GenerWorkerList wl in wls)
                {
                    ...
                    {
                        this.AddTD("<a href=\"javascript:WinOpen('" + BP.WF.Glo.CCFlowAppPath + "WF/FHLFlow.aspx?WorkID=" + wl.WorkID + "&FID=" + wl.FID + "&FK_Flow=" + nd.FK_Flow + "&FK_Node=" + this.FK_Node + "')\">打开</a>");
                    }
                    this.AddTREnd();
                }
                this.AddTableEnd();
                this.AddFieldSetEnd(); //.AddFieldSet("分流信息");
            }
        }
    }
}