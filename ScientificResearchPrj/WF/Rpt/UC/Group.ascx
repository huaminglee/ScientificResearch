...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'west',title:'分组条件',split:true" style="padding: 5px; width: 200px;">
        ...
        <div class="easyui-panel" title="图表" style="padding: 5px; margin-bottom:5px">
            <table class="Table" cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                <tr>
                    <td colspan="2">
                        <asp:CheckBox ID="CB_IsShowPict" runat="server" Text="显示图表" AutoPostBack="true" 
                            ToolTip="注意：仅当“显示内容”选择1项时，图表功能才可用！" />
                    </td>
                </tr>
                <tr>
                    <td style="width:80px">
                ...
                <tr>
                    <td colspan="2" style="text-align:right">
                        <asp:LinkButton ID="lbtnApply" runat="server" CssClass="easyui-linkbutton" 
                            data-options="iconCls:'icon-ok'" onclick="lbtnApply_Click">应用</asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
