...
namespace CCFlow.Web.Comm
{
    ...
    public partial class GroupEnsNum : BP.Web.WebPage
    {
        ...
        public void BindNums()
        {
            ...
            Map map = this.HisEn.EnMap;
            this.UCSys2.AddTable("class='Table' cellspacing='0' cellpadding='0' border='0' style='border-style:none;width:100%'");
        ...
        public DataTable BingDG()
        {
            ...
            if (this.CB_IsShowPict.Checked)
            {
                ...
                try
                {
                    ...
                    //增加柱状图
                    UCSys4.Add("    <div title='柱状图' data-options=\"iconCls:'icon-columnchart'\" style='padding:5px;text-align:center'>" + Environment.NewLine);
                    UCSys4.GenerateColumnChart(dt, AttrsOfGroup[0].Key + "T", AttrsOfGroup[0].Desc, yfields, this.Title, chartWidth, chartHeight);
                    UCSys4.Add("    </div>" + Environment.NewLine);

                    //增加饼图
                    UCSys4.Add("    <div title='饼状图' data-options=\"iconCls:'icon-piechart'\" style='padding:5px;text-align:center'>" + Environment.NewLine);
                    UCSys4.GeneratePieChart(dt, AttrsOfGroup[0].Key + "T", AttrsOfGroup[0].Desc, yfields, this.Title, chartWidth, chartHeight);
                    UCSys4.Add("    </div>" + Environment.NewLine);

                    //增加拆线图
                    UCSys4.Add("    <div title='折线图' data-options=\"iconCls:'icon-linechart'\" style='padding:5px;text-align:center'>" + Environment.NewLine);
