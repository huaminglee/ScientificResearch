...
function TBHelp(ctrl, appPath, enName, attrKey, FK_Flow) {//双击多行文本框
    //    var url = GetLocalWFPreHref();
    //    url = url + "/WF/Comm/HelperOfTBEUI.aspx?EnsName=" + enName + "&AttrKey=" + attrKey + "&WordsSort=3" + "&FK_Flow=" + FK_Flow;
    var url = "/WF/Comm/HelperOfTBEUI.aspx?EnsName=" + enName + "&AttrKey=" + attrKey + "&WordsSort=3" + "&FK_Flow=" + FK_Flow + "&id=" + ctrl;
    //    if (window.ActiveXObject) {
    var explorer = window.navigator.userAgent;
    var str = "";
