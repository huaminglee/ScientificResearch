...
var BS_ = {
        ...
        onLoadSuccess:function(data, status){
            ...
            if (data.state == "0") {
                ...
                _CommomOperation.getPropertygridDataFormJsonResult(SJSFShenHeOriginResult, currentPrefix);
                ...
                loadLinks(SJSFShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex, CanLinkDelete.YES);

                //加载附件
                var rowIndex = _CommomOperation.getRowIndexById(currentPrefix + "Attach");
                loadAttachs(SJSFShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex, CanAttachDelete.YES);
       ...
       baoCun: function () {
        ...
        addLink: function () {
            ...
            if (saveResult == true) {
                ...
                var OID = SJSFShenHeOriginResult.rows[0].OID;
