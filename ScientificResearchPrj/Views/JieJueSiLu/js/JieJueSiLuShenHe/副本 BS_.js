...
var BS_ = {
        ...
        onLoadSuccess:function(data, status){
            ...
            if (data.state == "0") {
                ...
                BS_.getPropertygridDataFormJsonResult(JJSLShenHeOriginResult, "JJSLSH_");
                ...
                if (JJSLShenHeOriginResult.rows[0].ShenHeJieGuo == SHENHEJIEGUO.RETURN) {
                    ...
                    for (var i = 0; i < newData.rows.length; i++) {
                        if (newData.rows[i].id == "JJSLSH_ShenHeJieGuo") {
        ...
        onSelectReturnToNodeCombobox: function(rec) {
            ...
            var newData = $("#pg").propertygrid('getData');
            for (var i = 0; i < newData.rows.length; i++) {
                if (newData.rows[i].id == "JJSLSH_ShenHeYiJian") {
       ...
       baoCun: function () {
        ...
        ifColumnNeedCompare: function (columnName) {
            if (columnName == "JJSLSH_ShenHeShiJian" ||
                columnName == "JJSLSH_ShenHeJieGuo" ||
                columnName == "JJSLSH_ShenHeYiJian")
                return true;
            else
                return false;
        },
        ...
        getNewRowFromPropertygrid: function () {
            ...
            newRow["ShenHeShiJian"] = BS_.getValueFromPropertygridById("JJSLSH_ShenHeShiJian");
            newRow["ShenHeJieGuo"] = BS_.getValueFromPropertygridById("JJSLSH_ShenHeJieGuo");
            newRow["ShenHeYiJian"] = BS_.getValueFromPropertygridById("JJSLSH_ShenHeYiJian");
        ...
        faSong: function () {
            ...
            if (saveResult == true) {
                ...
                for (var i = 0; i < data.rows.length; i++) {
                    if (data.rows[i].id == "JJSLSH_ShenHeJieGuo") {
                        //退回
        ...
        getReturnDataFromPropertygrid: function () {
            ...
            newRow["TuiHuiLiYou"] = BS_.getValueFromPropertygridById("JJSLSH_ShenHeYiJian");
            newRow["FK_Flow"] =  FK_Flow;
            newRow["WorkID"] =  WorkID;
            newRow["FK_Node"] = FK_Node;
            newRow["FID"] = FID;
