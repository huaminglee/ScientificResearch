...
var BS_ = {
        ...
        onLoadSuccess:function(data, status){
            ...
            if (data.state == "0") {
                ...
                _CommomOperation.getPropertygridDataFormJsonResult(XQFXShenHeOriginResult, currentPrefix);
                ...
                loadLinks(XQFXShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex, CanLinkDelete.YES);

                //加载附件
                var rowIndex2 = _CommomOperation.getRowIndexById(currentPrefix + "Attach");
                loadAttachs(XQFXShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex2, CanAttachDelete.YES);
        ...
        addLink: function () {
            ...
            if (saveResult == true) {
                ...
                var OID = XQFXShenHeOriginResult.rows[0].OID;
