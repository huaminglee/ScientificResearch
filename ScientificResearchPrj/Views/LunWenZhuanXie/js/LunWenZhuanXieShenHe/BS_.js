...
var BS_ = {
        ...
        onLoadSuccess:function(data, status){
            ...
            if (data.state == "0") {
                ...
                _CommomOperation.getPropertygridDataFormJsonResult(LWZXShenHeOriginResult, currentPrefix);
                ...
                loadLinks(LWZXShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex, CanLinkDelete.YES);
                //加载附件
                var rowIndex2 = _CommomOperation.getRowIndexById(currentPrefix + "Attach");
                loadAttachs(LWZXShenHeOriginResult.rows[0].OID, IsShenHe.YES, rowIndex2, CanAttachDelete.YES);
       ...
       baoCun: function () {
        ...
        addLink: function () {
            ...
            if (saveResult == true) {
                ...
                var OID = LWZXShenHeOriginResult.rows[0].OID;
