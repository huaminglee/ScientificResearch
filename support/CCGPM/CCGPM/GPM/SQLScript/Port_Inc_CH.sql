...
INSERT INTO Port_Dept (No,Name,ParentNo,FK_DeptType,Leader,IsDir) VALUES('1099','外来单位','100','02','Guest',1)  ;


-- Port_StationType ;
DELETE FROM Port_StationType;
INSERT INTO Port_StationType (No,Name) VALUES('01','高层');
INSERT INTO Port_StationType (No,Name) VALUES('02','中层');
INSERT INTO Port_StationType (No,Name) VALUES('03','基层');
 
-- Port_Station ;
DELETE FROM Port_Station;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('01','总经理','01') ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('02','市场部经理','02');
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('03','研发部经理','02')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('04','客服部经理','02')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('05','财务部经理','02')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('06','人力资源部经理','02')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('07','销售人员岗','03')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('08','程序员岗','03')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('09','技术服务岗','03')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('10','出纳岗','03')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('11','人力资源助理岗','03')  ;
INSERT INTO Port_Station (No,Name,FK_StationType) VALUES('12','外来人员岗','03')  ;
...
INSERT INTO Port_DeptEmpStation (MyPK,FK_Dept,FK_Emp,FK_Station) VALUES('1003_fuhui_09','fuhui','1003','09') ; 
