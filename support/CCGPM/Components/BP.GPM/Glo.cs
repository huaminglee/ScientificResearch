...
namespace BP.GPM
{
    public class Glo
    {
        ...
        public static void DoInstallDataBase(string lang, string yunXingHuanjing)
        {
            ...
            #region 3, 执行基本的 sql
            string sqlscript = SystemConfig.PathOfWebApp + "\\GPM\\SQLScript\\Port_Inc_CH.sql";
            ...
            #region 6, 创建视图。
            sqlscript = SystemConfig.PathOfWebApp + "\\GPM\\SQLScript\\GPM_VIEW.sql";
        ...
        {
            string sqlscript = SystemConfig.PathOfWebApp + "\\GPM\\SQLScript\\CCIM.sql";
            BP.DA.DBAccess.RunSQLScriptGo(sqlscript);
        }
